...
/**
 * CartoDialect for Databricks Lakehouse.
 *
 * @author Tom Diepenbrock <tom.diepenbrock@databricks.com>
 */
public class CartoDialect extends DatabricksSQLDialect {

	
	private Logger LOGGER;
	
    public CartoDialect(JDBCDataStore dataStore, Integer refreshPeriod) {
...
//        column.setRestriction(getRestrictions(columns, cx));
	...
	public void setGeometryValue(Geometry g, int dimension, int srid, Class binding, PreparedStatement ps, int column)
			throws SQLException {
		LOGGER.fine("in setGeometryValue");
        if (g != null) {
	...
	public PreparedFilterToSQL createPreparedFilterToSQL() {
		...
		CartoFilterToSQL f2s = new CartoFilterToSQL(this);
