...
__all__ = [
    ...
    "update_checkpoint_dir", "set_checkpoint_on", "set_checkpoint_off",
    "has_context", "is_use_checkpoint", "get_checkpoint_dir", "reset_checkpoint",
...
def enable_gdal(spark: SparkSession, with_checkpoint_dir: str = None) -> None:
    ...
    try:
        ...
        if with_checkpoint_dir:
            print(f"checkpoint path '{with_checkpoint_dir}' configured for this session.")
