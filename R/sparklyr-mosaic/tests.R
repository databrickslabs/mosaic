...
config$`spark.databricks.labs.mosaic.tile.tmp.prefix` <- paste0(getwd(), "/mosaic_tmp", sep="")
config$`spark.databricks.labs.mosaic.tile.checkpoint` <- paste0(getwd(), "/mosaic_checkpoint", sep="")
