...
class TestCoordinateMinMaxCodegen extends AnyFlatSpec with CoordinateMinMaxBehaviors with SparkCodeGenSuite {
    ...
    "ST_xmin" should "return minimum x coordinate for any index system and any geometry API" in {
        ...
        it should behave like xMinCodegen(MosaicContext.build(BNGIndexSystem, ESRI), spark)
        it should behave like xMinCodegen(MosaicContext.build(BNGIndexSystem, JTS), spark)
    ...
    "ST_xmax" should "return maximum x coordinate for any index system and any geometry API" in {
        ...
        it should behave like xMaxCodegen(MosaicContext.build(BNGIndexSystem, ESRI), spark)
        it should behave like xMaxCodegen(MosaicContext.build(BNGIndexSystem, JTS), spark)
    ...
    "ST_ymin" should "return minimum y coordinate for any index system and any geometry API" in {
        ...
        it should behave like yMinCodegen(MosaicContext.build(BNGIndexSystem, ESRI), spark)
        it should behave like yMinCodegen(MosaicContext.build(BNGIndexSystem, JTS), spark)
    ...
    "ST_ymax" should "return maximum y coordinate for any index system and any geometry API" in {
        ...
        it should behave like yMaxCodegen(MosaicContext.build(BNGIndexSystem, ESRI), spark)
        it should behave like yMaxCodegen(MosaicContext.build(BNGIndexSystem, JTS), spark)
