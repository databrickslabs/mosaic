...
trait ST_TranslateBehaviors extends QueryTest {
    ...
    def translateCodegen(indexSystem: IndexSystem, geometryAPI: GeometryAPI): Unit = {
        ...
        val stTranslate = ST_Translate(lit(1).expr, lit(1.1).expr, lit(1.2).expr, mc.exprConfig)
    ...
    def auxiliaryMethods(indexSystem: IndexSystem, geometryAPI: GeometryAPI): Unit = {
        ...
        val stTranslate = ST_Translate(lit("POINT (1 1)").expr, lit(1.1).expr, lit(1.2).expr, mc.exprConfig)
