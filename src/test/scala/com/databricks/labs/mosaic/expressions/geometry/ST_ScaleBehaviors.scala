...
trait ST_ScaleBehaviors extends QueryTest {
    ...
    def scaleCodegen(indexSystem: IndexSystem, geometryAPI: GeometryAPI): Unit = {
        ...
        val stScale = ST_Scale(lit(1).expr, lit(1.1).expr, lit(1.2).expr, mc.exprConfig)
    ...
    def auxiliaryMethods(indexSystem: IndexSystem, geometryAPI: GeometryAPI): Unit = {
        ...
        val stScale = ST_Scale(lit("POLYGON (1 1, 2 2, 3 3, 4 4, 1 1)").expr, lit(1.1).expr, lit(1.2).expr, mc.exprConfig)
