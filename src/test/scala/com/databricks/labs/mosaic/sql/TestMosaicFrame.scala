...
class TestMosaicFrame extends AnyFlatSpec with MosaicFrameBehaviors with SparkSuite {
    ...
    "MosaicFrame" should "suggest an appropriate resolution to index a set of polygon geometries" in {
        ...
        it should behave like testGetOptimalResolution(spark, MosaicContext.build(BNGIndexSystem, ESRI), 2, -4)
        it should behave like testGetOptimalResolution(spark, MosaicContext.build(BNGIndexSystem, JTS), 2, -4)
    }
