package com.dblabs.gbx.gridx.bng

import com.dblabs.gbx.gridx.grid.BNG
...
class BNG_ExpressionEvalTest extends PlanTest with SilentSparkSession {
    ...
    test("BNG_ expressions should run in spark sql without errors") {
        ...
        import com.dblabs.gbx.gridx.bng.functions._
        com.dblabs.gbx.gridx.bng.functions.register(spark)
