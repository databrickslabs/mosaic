...
import com.esri.core.geometry.{MultiPoint, Point, Polygon, Polyline, SpatialReference}
import com.esri.core.geometry.ogc.{OGCGeometry, OGCLineString, OGCMultiLineString, OGCMultiPoint, OGCMultiPolygon, OGCPoint, OGCPolygon}
