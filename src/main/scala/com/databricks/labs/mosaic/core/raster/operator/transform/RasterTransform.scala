...
trait RasterTransform {
    ...
    /**
      ...
      * returns the x and y coors in the projection of the tile. As per GDAL
      * documentation, the origin is the top left corner of the top left pixel
      *
      * @see
      *   https://gdal.org/tutorials/raster_api_tut.html
      * @param geoTransform
      *   The geo transform matrix of the tile.
      * @param x
    ...
    /**
      ...
      * returns the x and y coordinates of the tile pixel.
      *
      * @see
      *   // Reference:
      ...
      * @return
      *   A tuple of integers with the x and y coordinates of the tile pixel.
      */
