...
) extends UnaryVectorExpression[ST_NumPoints](inputGeom, returnsGeometry = false, exprConfig) {
...
object ST_NumPoints extends WithExpressionInfo {
    ...
    override def builder(exprConfig: ExprConfig): FunctionBuilder = {
        GenericExpressionFactory.getBaseBuilder[ST_NumPoints](1, exprConfig)
    }
