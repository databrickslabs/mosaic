...
case class RST_WorldToRasterCoordX(
...
) extends Raster2ArgExpression[RST_WorldToRasterCoordX](raster, x, y, IntegerType, returnsRaster = false, expressionConfig)
      with NullIntolerant
    ...
    override def rasterTransform(raster: MosaicRaster, arg1: Any, arg2: Any): Any = {
        ...
        val result = rasterAPI.fromWorldCoord(gt, xGeo, 0)._1
