...
class MosaicContext(indexSystem: IndexSystem, geometryAPI: GeometryAPI) extends Serializable with Logging {
    ...
    val exprConfig: ExprConfig = ExprConfig(spark)
    ...
    def register(
        ...
        exprConfig.updateSparkConf(spark) // any changes?
        ...
        mosaicRegistry.registerExpression[ST_Area](exprConfig)
        mosaicRegistry.registerExpression[ST_Buffer](exprConfig)
        mosaicRegistry.registerExpression[ST_BufferLoop](exprConfig)
        mosaicRegistry.registerExpression[ST_BufferCapStyle](exprConfig)
        mosaicRegistry.registerExpression[ST_Centroid](exprConfig)
        mosaicRegistry.registerExpression[ST_Contains](exprConfig)
        mosaicRegistry.registerExpression[ST_ConvexHull](exprConfig)
        mosaicRegistry.registerExpression[ST_ConcaveHull](exprConfig)
        mosaicRegistry.registerExpression[ST_Distance](exprConfig)
        mosaicRegistry.registerExpression[ST_Difference](exprConfig)
        mosaicRegistry.registerExpression[ST_Dimension](exprConfig)
        mosaicRegistry.registerExpression[ST_Envelope](exprConfig)
        mosaicRegistry.registerExpression[ST_GeometryType](exprConfig)
        mosaicRegistry.registerExpression[ST_HasValidCoordinates](exprConfig)
        mosaicRegistry.registerExpression[ST_Intersection](exprConfig)
        mosaicRegistry.registerExpression[ST_Intersects](exprConfig)
        mosaicRegistry.registerExpression[ST_IsValid](exprConfig)
        mosaicRegistry.registerExpression[ST_Length](exprConfig)
        mosaicRegistry.registerExpression[ST_Length]("st_perimeter", exprConfig)
        mosaicRegistry.registerExpression[ST_XMin](exprConfig)
        mosaicRegistry.registerExpression[ST_XMax](exprConfig)
        mosaicRegistry.registerExpression[ST_YMin](exprConfig)
        mosaicRegistry.registerExpression[ST_YMax](exprConfig)
        mosaicRegistry.registerExpression[ST_ZMin](exprConfig)
        mosaicRegistry.registerExpression[ST_ZMax](exprConfig)
        mosaicRegistry.registerExpression[ST_NumPoints](exprConfig)
        mosaicRegistry.registerExpression[ST_Rotate](exprConfig)
        mosaicRegistry.registerExpression[ST_Scale](exprConfig)
        mosaicRegistry.registerExpression[ST_SetSRID](exprConfig)
        mosaicRegistry.registerExpression[ST_Simplify](exprConfig)
        mosaicRegistry.registerExpression[ST_SRID](exprConfig)
        mosaicRegistry.registerExpression[ST_Translate](exprConfig)
        mosaicRegistry.registerExpression[ST_Transform](exprConfig)
        mosaicRegistry.registerExpression[ST_UnaryUnion](exprConfig)
        mosaicRegistry.registerExpression[ST_Union](exprConfig)
        mosaicRegistry.registerExpression[ST_UpdateSRID](exprConfig)
        mosaicRegistry.registerExpression[ST_Within](exprConfig)
        mosaicRegistry.registerExpression[ST_X](exprConfig)
        mosaicRegistry.registerExpression[ST_Y](exprConfig)
        mosaicRegistry.registerExpression[ST_Z](exprConfig)
        mosaicRegistry.registerExpression[ST_Haversine](exprConfig)
        ...
        mosaicRegistry.registerExpression[RST_Avg](exprConfig)
        mosaicRegistry.registerExpression[RST_BandMetaData](exprConfig)
        mosaicRegistry.registerExpression[RST_BoundingBox](exprConfig)
        mosaicRegistry.registerExpression[RST_Clip](exprConfig)
        mosaicRegistry.registerExpression[RST_CombineAvg](exprConfig)
        mosaicRegistry.registerExpression[RST_Convolve](exprConfig)
        mosaicRegistry.registerExpression[RST_DerivedBand](exprConfig)
        mosaicRegistry.registerExpression[RST_Filter](exprConfig)
        mosaicRegistry.registerExpression[RST_GeoReference](exprConfig)
        mosaicRegistry.registerExpression[RST_GetNoData](exprConfig)
        mosaicRegistry.registerExpression[RST_GetSubdataset](exprConfig)
        mosaicRegistry.registerExpression[RST_Height](exprConfig)
        mosaicRegistry.registerExpression[RST_InitNoData](exprConfig)
        mosaicRegistry.registerExpression[RST_IsEmpty](exprConfig)
        mosaicRegistry.registerExpression[RST_MakeTiles](exprConfig)
        mosaicRegistry.registerExpression[RST_Max](exprConfig)
        mosaicRegistry.registerExpression[RST_Min](exprConfig)
        mosaicRegistry.registerExpression[RST_Median](exprConfig)
        mosaicRegistry.registerExpression[RST_MemSize](exprConfig)
        mosaicRegistry.registerExpression[RST_Merge](exprConfig)
        mosaicRegistry.registerExpression[RST_FromBands](exprConfig)
        mosaicRegistry.registerExpression[RST_MetaData](exprConfig)
        mosaicRegistry.registerExpression[RST_MapAlgebra](exprConfig)
        mosaicRegistry.registerExpression[RST_NDVI](exprConfig)
        mosaicRegistry.registerExpression[RST_NumBands](exprConfig)
        mosaicRegistry.registerExpression[RST_PixelWidth](exprConfig)
        mosaicRegistry.registerExpression[RST_PixelHeight](exprConfig)
        mosaicRegistry.registerExpression[RST_PixelCount](exprConfig)
        mosaicRegistry.registerExpression[RST_RasterToGridAvg](exprConfig)
        mosaicRegistry.registerExpression[RST_RasterToGridMax](exprConfig)
        mosaicRegistry.registerExpression[RST_RasterToGridMin](exprConfig)
        mosaicRegistry.registerExpression[RST_RasterToGridMedian](exprConfig)
        mosaicRegistry.registerExpression[RST_RasterToGridCount](exprConfig)
        mosaicRegistry.registerExpression[RST_RasterToWorldCoord](exprConfig)
        mosaicRegistry.registerExpression[RST_RasterToWorldCoordX](exprConfig)
        mosaicRegistry.registerExpression[RST_RasterToWorldCoordY](exprConfig)
        mosaicRegistry.registerExpression[RST_ReTile](exprConfig)
        mosaicRegistry.registerExpression[RST_SeparateBands](exprConfig)
        mosaicRegistry.registerExpression[RST_Rotation](exprConfig)
        mosaicRegistry.registerExpression[RST_ScaleX](exprConfig)
        mosaicRegistry.registerExpression[RST_ScaleY](exprConfig)
        mosaicRegistry.registerExpression[RST_SetNoData](exprConfig)
        mosaicRegistry.registerExpression[RST_SkewX](exprConfig)
        mosaicRegistry.registerExpression[RST_SkewY](exprConfig)
        mosaicRegistry.registerExpression[RST_SRID](exprConfig)
        mosaicRegistry.registerExpression[RST_SetSRID](exprConfig)
        mosaicRegistry.registerExpression[RST_Subdatasets](exprConfig)
        mosaicRegistry.registerExpression[RST_Summary](exprConfig)
        mosaicRegistry.registerExpression[RST_Tessellate](exprConfig)
        mosaicRegistry.registerExpression[RST_Transform](exprConfig)
        mosaicRegistry.registerExpression[RST_FromContent](exprConfig)
        mosaicRegistry.registerExpression[RST_FromFile](exprConfig)
        mosaicRegistry.registerExpression[RST_ToOverlappingTiles](exprConfig)
        mosaicRegistry.registerExpression[RST_TryOpen](exprConfig)
        mosaicRegistry.registerExpression[RST_Subdivide](exprConfig)
        mosaicRegistry.registerExpression[RST_UpperLeftX](exprConfig)
        mosaicRegistry.registerExpression[RST_UpperLeftY](exprConfig)
        mosaicRegistry.registerExpression[RST_Width](exprConfig)
        mosaicRegistry.registerExpression[RST_WorldToRasterCoord](exprConfig)
        mosaicRegistry.registerExpression[RST_WorldToRasterCoordX](exprConfig)
        mosaicRegistry.registerExpression[RST_WorldToRasterCoordY](exprConfig)
        mosaicRegistry.registerExpression[RST_Write](exprConfig)

        /** Aggregators */
        registry.registerFunction(
          FunctionIdentifier("st_asgeojsontile_agg", database),
          ST_AsGeojsonTileAgg.registryExpressionInfo(database),
          (exprs: Seq[Expression]) => ST_AsGeojsonTileAgg(exprs(0), exprs(1), exprConfig, 0, 0)
        )
        registry.registerFunction(
          FunctionIdentifier("st_asmvttile_agg", database),
          ST_AsMVTTileAgg.registryExpressionInfo(database),
          (exprs: Seq[Expression]) => ST_AsMVTTileAgg(exprs(0), exprs(1), exprs(2), exprConfig, 0, 0)
        )
        registry.registerFunction(
    ...
    object functions extends Serializable {
        ...
        def st_area(geom: Column): Column = ColumnAdapter(ST_Area(geom.expr, exprConfig))
        ...
        def st_buffer(geom: Column, radius: Column, buffer_style_parameters: Column): Column =
            ColumnAdapter(ST_Buffer(geom.expr, radius.cast("double").expr, buffer_style_parameters.cast("string").expr, exprConfig))
        def st_buffer(geom: Column, radius: Double, buffer_style_parameters: Column): Column =
            ColumnAdapter(
              ST_Buffer(geom.expr, lit(radius).cast("double").expr, lit(buffer_style_parameters).cast("string").expr, exprConfig)
            )
        def st_bufferloop(geom: Column, r1: Column, r2: Column): Column =
            ColumnAdapter(ST_BufferLoop(geom.expr, r1.cast("double").expr, r2.cast("double").expr, exprConfig))
        def st_bufferloop(geom: Column, r1: Double, r2: Double): Column =
            ColumnAdapter(ST_BufferLoop(geom.expr, lit(r1).cast("double").expr, lit(r2).cast("double").expr, exprConfig))
        def st_buffer_cap_style(geom: Column, radius: Column, capStyle: Column): Column =
            ColumnAdapter(ST_BufferCapStyle(geom.expr, radius.cast("double").expr, capStyle.expr, exprConfig))
        def st_buffer_cap_style(geom: Column, radius: Double, capStyle: String): Column =
            ColumnAdapter(ST_BufferCapStyle(geom.expr, lit(radius).cast("double").expr, lit(capStyle).expr, exprConfig))
        def st_centroid(geom: Column): Column = ColumnAdapter(ST_Centroid(geom.expr, exprConfig))
        def st_convexhull(geom: Column): Column = ColumnAdapter(ST_ConvexHull(geom.expr, exprConfig))
        def st_concavehull(geom: Column, concavity: Column, allowHoles: Column): Column =
            ColumnAdapter(ST_ConcaveHull(geom.expr, concavity.cast("double").expr, allowHoles.expr, exprConfig))
        def st_concavehull(geom: Column, concavity: Double, allowHoles: Boolean): Column =
            ColumnAdapter(ST_ConcaveHull(geom.expr, lit(concavity).cast("double").expr, lit(allowHoles).expr, exprConfig))
        def st_concavehull(geom: Column, concavity: Double): Column =
            ColumnAdapter(ST_ConcaveHull(geom.expr, lit(concavity).cast("double").expr, lit(false).expr, exprConfig))
        def st_difference(geom1: Column, geom2: Column): Column = ColumnAdapter(ST_Difference(geom1.expr, geom2.expr, exprConfig))
        def st_distance(geom1: Column, geom2: Column): Column = ColumnAdapter(ST_Distance(geom1.expr, geom2.expr, exprConfig))
        def st_dimension(geom: Column): Column = ColumnAdapter(ST_Dimension(geom.expr, exprConfig))
        def st_dump(geom: Column): Column = ColumnAdapter(FlattenPolygons(geom.expr, geometryAPI.name))
        def st_envelope(geom: Column): Column = ColumnAdapter(ST_Envelope(geom.expr, exprConfig))
        def st_geometrytype(geom: Column): Column = ColumnAdapter(ST_GeometryType(geom.expr, exprConfig))
        def st_hasvalidcoordinates(geom: Column, crsCode: Column, which: Column): Column =
            ColumnAdapter(ST_HasValidCoordinates(geom.expr, crsCode.expr, which.expr, exprConfig))
        def st_intersection(left: Column, right: Column): Column = ColumnAdapter(ST_Intersection(left.expr, right.expr, exprConfig))
        def st_isvalid(geom: Column): Column = ColumnAdapter(ST_IsValid(geom.expr, exprConfig))
        def st_length(geom: Column): Column = ColumnAdapter(ST_Length(geom.expr, exprConfig))
        def st_numpoints(geom: Column): Column = ColumnAdapter(ST_NumPoints(geom.expr, exprConfig))
        def st_perimeter(geom: Column): Column = ColumnAdapter(ST_Length(geom.expr, exprConfig))
        ...
        def st_rotate(geom1: Column, td: Column): Column = ColumnAdapter(ST_Rotate(geom1.expr, td.expr, exprConfig))
        def st_scale(geom1: Column, xd: Column, yd: Column): Column =
            ColumnAdapter(ST_Scale(geom1.expr, xd.expr, yd.expr, exprConfig))
        def st_setsrid(geom: Column, srid: Column): Column = ColumnAdapter(ST_SetSRID(geom.expr, srid.expr, exprConfig))
        def st_simplify(geom: Column, tolerance: Column): Column =
            ColumnAdapter(ST_Simplify(geom.expr, tolerance.cast("double").expr, exprConfig))
        def st_simplify(geom: Column, tolerance: Double): Column =
            ColumnAdapter(ST_Simplify(geom.expr, lit(tolerance).cast("double").expr, exprConfig))
        def st_srid(geom: Column): Column = ColumnAdapter(ST_SRID(geom.expr, exprConfig))
        def st_transform(geom: Column, srid: Column): Column = ColumnAdapter(ST_Transform(geom.expr, srid.expr, exprConfig))
        def st_translate(geom1: Column, xd: Column, yd: Column): Column =
            ColumnAdapter(ST_Translate(geom1.expr, xd.expr, yd.expr, exprConfig))
        def st_x(geom: Column): Column = ColumnAdapter(ST_X(geom.expr, exprConfig))
        def st_y(geom: Column): Column = ColumnAdapter(ST_Y(geom.expr, exprConfig))
        def st_z(geom: Column): Column = ColumnAdapter(ST_Z(geom.expr, exprConfig))
        def st_xmax(geom: Column): Column = ColumnAdapter(ST_MinMaxXYZ(geom.expr, exprConfig, "X", "MAX"))
        def st_xmin(geom: Column): Column = ColumnAdapter(ST_MinMaxXYZ(geom.expr, exprConfig, "X", "MIN"))
        def st_ymax(geom: Column): Column = ColumnAdapter(ST_MinMaxXYZ(geom.expr, exprConfig, "Y", "MAX"))
        def st_ymin(geom: Column): Column = ColumnAdapter(ST_MinMaxXYZ(geom.expr, exprConfig, "Y", "MIN"))
        def st_zmax(geom: Column): Column = ColumnAdapter(ST_MinMaxXYZ(geom.expr, exprConfig, "Z", "MAX"))
        def st_zmin(geom: Column): Column = ColumnAdapter(ST_MinMaxXYZ(geom.expr, exprConfig, "Z", "MIN"))
        def st_union(leftGeom: Column, rightGeom: Column): Column = ColumnAdapter(ST_Union(leftGeom.expr, rightGeom.expr, exprConfig))
        def st_unaryunion(geom: Column): Column = ColumnAdapter(ST_UnaryUnion(geom.expr, exprConfig))
        def st_updatesrid(geom: Column, srcSRID: Column, destSRID: Column): Column =
            ColumnAdapter(ST_UpdateSRID(geom.expr, srcSRID.cast("int").expr, destSRID.cast("int").expr, exprConfig))
        def st_updatesrid(geom: Column, srcSRID: Int, destSRID: Int): Column =
            ColumnAdapter(ST_UpdateSRID(geom.expr, lit(srcSRID).expr, lit(destSRID).expr, exprConfig))
        ...
        /** Spatial predicates */
        def st_contains(geom1: Column, geom2: Column): Column = ColumnAdapter(ST_Contains(geom1.expr, geom2.expr, exprConfig))
        def st_intersects(left: Column, right: Column): Column = ColumnAdapter(ST_Intersects(left.expr, right.expr, exprConfig))
        def st_within(geom1: Column, geom2: Column): Column = ColumnAdapter(ST_Within(geom1.expr, geom2.expr, exprConfig))

        /** RasterAPI dependent functions */
        def rst_bandmetadata(raster: Column, band: Column): Column =
            ColumnAdapter(RST_BandMetaData(raster.expr, band.expr, exprConfig))
        def rst_bandmetadata(raster: Column, band: Int): Column =
            ColumnAdapter(RST_BandMetaData(raster.expr, lit(band).expr, exprConfig))
        def rst_boundingbox(raster: Column): Column = ColumnAdapter(RST_BoundingBox(raster.expr, exprConfig))
        def rst_clip(raster: Column, geometry: Column): Column =
            ColumnAdapter(RST_Clip(raster.expr, geometry.expr, lit(true).expr, exprConfig))
        def rst_clip(raster: Column, geometry: Column, cutline: Boolean): Column =
            ColumnAdapter(RST_Clip(raster.expr, geometry.expr, lit(cutline).expr, exprConfig))
        def rst_clip(raster: Column, geometry: Column, cutline: Column): Column =
            ColumnAdapter(RST_Clip(raster.expr, geometry.expr, cutline.expr, exprConfig))
        def rst_convolve(raster: Column, kernel: Column): Column = ColumnAdapter(RST_Convolve(raster.expr, kernel.expr, exprConfig))
        def rst_pixelcount(raster: Column): Column = ColumnAdapter(RST_PixelCount(raster.expr, lit(false).expr, lit(false).expr, exprConfig))
        def rst_pixelcount(raster: Column, countNoData: Column): Column = ColumnAdapter(RST_PixelCount(raster.expr, countNoData.expr, lit(false).expr, exprConfig))
        def rst_pixelcount(raster: Column, countNoData: Column, countAll: Column): Column = ColumnAdapter(RST_PixelCount(raster.expr, countNoData.expr, countAll.expr, exprConfig))
        def rst_combineavg(rasterArray: Column): Column = ColumnAdapter(RST_CombineAvg(rasterArray.expr, exprConfig))
        def rst_derivedband(raster: Column, pythonFunc: Column, funcName: Column): Column =
            ColumnAdapter(RST_DerivedBand(raster.expr, pythonFunc.expr, funcName.expr, exprConfig))
        def rst_filter(raster: Column, kernelSize: Column, operation: Column): Column =
            ColumnAdapter(RST_Filter(raster.expr, kernelSize.expr, operation.expr, exprConfig))
        def rst_filter(raster: Column, kernelSize: Int, operation: String): Column =
            ColumnAdapter(RST_Filter(raster.expr, lit(kernelSize).expr, lit(operation).expr, exprConfig))
        def rst_georeference(raster: Column): Column = ColumnAdapter(RST_GeoReference(raster.expr, exprConfig))
        def rst_getnodata(raster: Column): Column = ColumnAdapter(RST_GetNoData(raster.expr, exprConfig))
        def rst_getsubdataset(raster: Column, subdatasetName: Column): Column =
            ColumnAdapter(RST_GetSubdataset(raster.expr, subdatasetName.expr, exprConfig))
        def rst_getsubdataset(raster: Column, subdatasetName: String): Column =
            ColumnAdapter(RST_GetSubdataset(raster.expr, lit(subdatasetName).expr, exprConfig))
        def rst_height(raster: Column): Column = ColumnAdapter(RST_Height(raster.expr, exprConfig))
        def rst_initnodata(raster: Column): Column = ColumnAdapter(RST_InitNoData(raster.expr, exprConfig))
        def rst_isempty(raster: Column): Column = ColumnAdapter(RST_IsEmpty(raster.expr, exprConfig))
        def rst_maketiles(input: Column, driver: Column, size: Column, withCheckpoint: Column): Column =
            ColumnAdapter(RST_MakeTiles(input.expr, driver.expr, size.expr, withCheckpoint.expr, exprConfig))
        def rst_maketiles(input: Column, driver: String, size: Int, withCheckpoint: Boolean): Column =
            ColumnAdapter(RST_MakeTiles(input.expr, lit(driver).expr, lit(size).expr, lit(withCheckpoint).expr, exprConfig))
        def rst_maketiles(input: Column, driver: String, size: Int): Column =
            ColumnAdapter(RST_MakeTiles(input.expr, lit(driver).expr, lit(size).expr, lit(false).expr, exprConfig))
        def rst_maketiles(input: Column): Column =
            ColumnAdapter(RST_MakeTiles(input.expr, lit("no_driver").expr, lit(-1).expr, lit(false).expr, exprConfig))
        def rst_max(raster: Column): Column = ColumnAdapter(RST_Max(raster.expr, exprConfig))
        def rst_min(raster: Column): Column = ColumnAdapter(RST_Min(raster.expr, exprConfig))
        def rst_median(raster: Column): Column = ColumnAdapter(RST_Median(raster.expr, exprConfig))
        def rst_avg(raster: Column): Column = ColumnAdapter(RST_Avg(raster.expr, exprConfig))
        def rst_memsize(raster: Column): Column = ColumnAdapter(RST_MemSize(raster.expr, exprConfig))
        def rst_frombands(bandsArray: Column): Column = ColumnAdapter(RST_FromBands(bandsArray.expr, exprConfig))
        def rst_merge(rasterArray: Column): Column = ColumnAdapter(RST_Merge(rasterArray.expr, exprConfig))
        def rst_metadata(raster: Column): Column = ColumnAdapter(RST_MetaData(raster.expr, exprConfig))
        def rst_mapalgebra(rasterArray: Column, jsonSpec: Column): Column =
            ColumnAdapter(RST_MapAlgebra(rasterArray.expr, jsonSpec.expr, exprConfig))
        def rst_ndvi(raster: Column, band1: Column, band2: Column): Column =
            ColumnAdapter(RST_NDVI(raster.expr, band1.expr, band2.expr, exprConfig))
        def rst_ndvi(raster: Column, band1: Int, band2: Int): Column =
            ColumnAdapter(RST_NDVI(raster.expr, lit(band1).expr, lit(band2).expr, exprConfig))
        def rst_numbands(raster: Column): Column = ColumnAdapter(RST_NumBands(raster.expr, exprConfig))
        def rst_pixelheight(raster: Column): Column = ColumnAdapter(RST_PixelHeight(raster.expr, exprConfig))
        def rst_pixelwidth(raster: Column): Column = ColumnAdapter(RST_PixelWidth(raster.expr, exprConfig))
        def rst_rastertogridavg(raster: Column, resolution: Column): Column =
            ColumnAdapter(RST_RasterToGridAvg(raster.expr, resolution.expr, exprConfig))
        def rst_rastertogridcount(raster: Column, resolution: Column): Column =
            ColumnAdapter(RST_RasterToGridCount(raster.expr, resolution.expr, exprConfig))
        def rst_rastertogridmax(raster: Column, resolution: Column): Column =
            ColumnAdapter(RST_RasterToGridMax(raster.expr, resolution.expr, exprConfig))
        def rst_rastertogridmedian(raster: Column, resolution: Column): Column =
            ColumnAdapter(RST_RasterToGridMedian(raster.expr, resolution.expr, exprConfig))
        def rst_rastertogridmin(raster: Column, resolution: Column): Column =
            ColumnAdapter(RST_RasterToGridMin(raster.expr, resolution.expr, exprConfig))
        def rst_rastertoworldcoord(raster: Column, x: Column, y: Column): Column =
            ColumnAdapter(RST_RasterToWorldCoord(raster.expr, x.expr, y.expr, exprConfig))
        def rst_rastertoworldcoord(raster: Column, x: Int, y: Int): Column =
            ColumnAdapter(RST_RasterToWorldCoord(raster.expr, lit(x).expr, lit(y).expr, exprConfig))
        def rst_rastertoworldcoordx(raster: Column, x: Column, y: Column): Column =
            ColumnAdapter(RST_RasterToWorldCoordX(raster.expr, x.expr, y.expr, exprConfig))
        def rst_rastertoworldcoordx(raster: Column, x: Int, y: Int): Column =
            ColumnAdapter(RST_RasterToWorldCoordX(raster.expr, lit(x).expr, lit(y).expr, exprConfig))
        def rst_rastertoworldcoordy(raster: Column, x: Column, y: Column): Column =
            ColumnAdapter(RST_RasterToWorldCoordY(raster.expr, x.expr, y.expr, exprConfig))
        def rst_rastertoworldcoordy(raster: Column, x: Int, y: Int): Column =
            ColumnAdapter(RST_RasterToWorldCoordY(raster.expr, lit(x).expr, lit(y).expr, exprConfig))
        def rst_retile(raster: Column, tileWidth: Column, tileHeight: Column): Column =
            ColumnAdapter(RST_ReTile(raster.expr, tileWidth.expr, tileHeight.expr, exprConfig))
        def rst_retile(raster: Column, tileWidth: Int, tileHeight: Int): Column =
            ColumnAdapter(RST_ReTile(raster.expr, lit(tileWidth).expr, lit(tileHeight).expr, exprConfig))
        def rst_separatebands(raster: Column): Column = ColumnAdapter(RST_SeparateBands(raster.expr, exprConfig))
        def rst_rotation(raster: Column): Column = ColumnAdapter(RST_Rotation(raster.expr, exprConfig))
        def rst_scalex(raster: Column): Column = ColumnAdapter(RST_ScaleX(raster.expr, exprConfig))
        def rst_scaley(raster: Column): Column = ColumnAdapter(RST_ScaleY(raster.expr, exprConfig))
        def rst_setnodata(raster: Column, nodata: Column): Column = ColumnAdapter(RST_SetNoData(raster.expr, nodata.expr, exprConfig))
        def rst_setnodata(raster: Column, nodata: Double): Column =
            ColumnAdapter(RST_SetNoData(raster.expr, lit(nodata).expr, exprConfig))
        def rst_skewx(raster: Column): Column = ColumnAdapter(RST_SkewX(raster.expr, exprConfig))
        def rst_skewy(raster: Column): Column = ColumnAdapter(RST_SkewY(raster.expr, exprConfig))
        def rst_srid(raster: Column): Column = ColumnAdapter(RST_SRID(raster.expr, exprConfig))
        ...
        def rst_fromcontent(raster: Column, driver: Column, sizeInMB: Column): Column =
            ColumnAdapter(RST_FromContent(raster.expr, driver.expr, sizeInMB.expr, exprConfig))
        def rst_fromcontent(raster: Column, driver: String): Column =
            ColumnAdapter(RST_FromContent(raster.expr, lit(driver).expr, lit(-1).expr, exprConfig))
        def rst_fromcontent(raster: Column, driver: String, sizeInMB: Int): Column =
            ColumnAdapter(RST_FromContent(raster.expr, lit(driver).expr, lit(sizeInMB).expr, exprConfig))
        def rst_fromfile(raster: Column): Column = ColumnAdapter(RST_FromFile(raster.expr, lit(-1).expr, exprConfig))
        def rst_fromfile(raster: Column, sizeInMB: Column): Column =
            ColumnAdapter(RST_FromFile(raster.expr, sizeInMB.expr, exprConfig))
        def rst_fromfile(raster: Column, sizeInMB: Int): Column =
            ColumnAdapter(RST_FromFile(raster.expr, lit(sizeInMB).expr, exprConfig))
        def rst_tooverlappingtiles(raster: Column, width: Int, height: Int, overlap: Int): Column =
            ColumnAdapter(RST_ToOverlappingTiles(raster.expr, lit(width).expr, lit(height).expr, lit(overlap).expr, exprConfig))
        def rst_tooverlappingtiles(raster: Column, width: Column, height: Column, overlap: Column): Column =
            ColumnAdapter(RST_ToOverlappingTiles(raster.expr, width.expr, height.expr, overlap.expr, exprConfig))
        def rst_tryopen(raster: Column): Column = ColumnAdapter(RST_TryOpen(raster.expr, exprConfig))
        def rst_subdivide(raster: Column, sizeInMB: Column): Column =
            ColumnAdapter(RST_Subdivide(raster.expr, sizeInMB.expr, exprConfig))
        def rst_subdivide(raster: Column, sizeInMB: Int): Column =
            ColumnAdapter(RST_Subdivide(raster.expr, lit(sizeInMB).expr, exprConfig))
        def rst_upperleftx(raster: Column): Column = ColumnAdapter(RST_UpperLeftX(raster.expr, exprConfig))
        def rst_upperlefty(raster: Column): Column = ColumnAdapter(RST_UpperLeftY(raster.expr, exprConfig))
        def rst_width(raster: Column): Column = ColumnAdapter(RST_Width(raster.expr, exprConfig))
        def rst_worldtorastercoord(raster: Column, x: Column, y: Column): Column =
            ColumnAdapter(RST_WorldToRasterCoord(raster.expr, x.expr, y.expr, exprConfig))
        def rst_worldtorastercoord(raster: Column, x: Double, y: Double): Column =
            ColumnAdapter(RST_WorldToRasterCoord(raster.expr, lit(x).expr, lit(y).expr, exprConfig))
        def rst_worldtorastercoordx(raster: Column, x: Column, y: Column): Column =
            ColumnAdapter(RST_WorldToRasterCoordX(raster.expr, x.expr, y.expr, exprConfig))
        def rst_worldtorastercoordx(raster: Column, x: Double, y: Double): Column =
            ColumnAdapter(RST_WorldToRasterCoordX(raster.expr, lit(x).expr, lit(y).expr, exprConfig))
        def rst_worldtorastercoordy(raster: Column, x: Column, y: Column): Column =
            ColumnAdapter(RST_WorldToRasterCoordY(raster.expr, x.expr, y.expr, exprConfig))
        def rst_worldtorastercoordy(raster: Column, x: Double, y: Double): Column =
            ColumnAdapter(RST_WorldToRasterCoordY(raster.expr, lit(x).expr, lit(y).expr, exprConfig))
        def rst_write(input: Column, dir: Column): Column =
            ColumnAdapter(RST_Write(input.expr, dir.expr, exprConfig))
        def rst_write(input: Column, dir: String): Column =
            ColumnAdapter(RST_Write(input.expr, lit(dir).expr, exprConfig))

        /** Aggregators */

        def st_asgeojsontile_agg(geom: Column, attributes: Column): Column =
            ColumnAdapter(ST_AsGeojsonTileAgg(geom.expr, attributes.expr, exprConfig, 0, 0).toAggregateExpression(isDistinct = false))
        def st_asmvttile_agg(geom: Column, attributes: Column, zxyID: Column): Column =
            ColumnAdapter(
              ST_AsMVTTileAgg(geom.expr, attributes.expr, zxyID.expr, exprConfig, 0, 0).toAggregateExpression(isDistinct = false)
            )
        ...
        def rst_merge_agg(raster: Column): Column =
            ColumnAdapter(RST_MergeAgg(raster.expr, exprConfig).toAggregateExpression(isDistinct = false))
        def rst_combineavg_agg(raster: Column): Column =
            ColumnAdapter(RST_CombineAvgAgg(raster.expr, exprConfig).toAggregateExpression(isDistinct = false))
        def rst_derivedband_agg(raster: Column, pythonFunc: Column, funcName: Column): Column =
            ColumnAdapter(
              RST_DerivedBandAgg(raster.expr, pythonFunc.expr, funcName.expr, exprConfig).toAggregateExpression(isDistinct = false)
            )
        ...
        def st_centroid2D(geom: Column): Column = {
            struct(
              ColumnAdapter(ST_X(ST_Centroid(geom.expr, exprConfig), exprConfig)),
              ColumnAdapter(ST_Y(ST_Centroid(geom.expr, exprConfig), exprConfig))
            )
        }
