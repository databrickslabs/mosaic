package com.dblabs.gbx.vectorx.ds.ogr

import com.dblabs.gbx.expressions.ExpressionConfig
import com.dblabs.gbx.util.{HadoopUtils, NodeFileManager}
...
class OGR_Batch(schema: StructType, options: Map[String, String]) extends Scan with Batch {
    ...
    override def planInputPartitions(): Array[InputPartition] = {
        ...
        sparkSession.read.format("com.dblabs.gbx.ds.whitelist.WhitelistDataSource").option("path", inPath).load()
