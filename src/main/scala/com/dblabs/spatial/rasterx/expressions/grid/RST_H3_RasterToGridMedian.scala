package com.dblabs.spatial.rasterx.expressions.grid
...
case class RST_H3_RasterToGridMedian(
    ...
    override def prettyName: String = "rst_h3_rastertogridmedian"
...
object RST_H3_RasterToGridMedian extends WithExpressionInfo {
    ...
    override def name: String = "rst_h3_rastertogridmedian"
