...
import com.dblabs.spatial.rasterx.operations.PixelCombineRasters
...
case class RST_DerivedBandAgg(
    ...
    override def prettyName: String = "rst_derived_band_agg"
...
object RST_DerivedBandAgg extends WithExpressionInfo {
    ...
    override def name: String = "rst_derived_band_agg"
