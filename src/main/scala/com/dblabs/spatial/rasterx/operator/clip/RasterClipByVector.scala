package com.dblabs.spatial.rasterx.operator.clip
...
object RasterClipByVector {
    ...
    def clip(
        ...
        val clipperFile = VectorClipper.generateClipper(geometry, geomCRS, raster, geometryAPI)
        ...
        VectorClipper.cleanUpClipper(clipperFile)
        result
    }
