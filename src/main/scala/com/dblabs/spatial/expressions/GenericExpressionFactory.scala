...
object GenericExpressionFactory {
    ...
    /**
      ...
      */
    def construct[T <: Expression: ClassTag](args: Array[_ <: Expression], expressionConfig: ExpressionConfig): Expression = {
    ...
    /**
      ...
      */
    def getBaseBuilder[T <: Expression: ClassTag](nChildren: Int, expressionConfig: ExpressionConfig): FunctionBuilder =
