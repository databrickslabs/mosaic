...
case class BNGCellArea(
    ...
    override def replacement: Expression = invoke(BNGCellArea)

}

object BNGCellArea extends WithExpressionInfo {
    ...
    override def builder(expressionConfig: ExpressionConfig): FunctionBuilder = {
        GenericExpressionFactory.getBaseBuilder[BNGCellArea](1, expressionConfig)
    }
